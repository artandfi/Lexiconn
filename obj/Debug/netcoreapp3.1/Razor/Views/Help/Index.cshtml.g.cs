#pragma checksum "D:\Женя\Projects\C# Projects\Dictionary\Lexiconn\Views\Help\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "45f5e7c291253862de111c7970f27d95062d3502"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"45f5e7c291253862de111c7970f27d95062d3502", @"/Views/Help/Index.cshtml")]
...
<h3>Слова</h3>
<p style=""font-size:15px;"">
    При створенні нового запи");
            WriteLiteral(@"су необхідно вказати слово, мову, категорію та принаймні один переклад. Якщо перекладів декілька &#8211; перераховуйте їх через кому.
    <br />
...
<p style=""font-size:15px;"">
    ...
    Щоб заповнити словник записами із зовнішнього носія, потрібно завантажити Excel-файл (.xls, .xlsx) у визначеному форматі. ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "45f5e7c291253862de111c7970f27d95062d35026967", async() => {
    ...
    <br />
    Пе");
            WriteLiteral(@"ред завантаженням поточних записів можна вибрати критерії фільтрації цих записів у відповідних випадних списках. Якщо дані за встановленими критеріями відсутні, завантаження файлу відхиляється з повідомленням про помилку.
    <br />
